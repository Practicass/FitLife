    ...
    <div className="page-adminHome">
       ...
       <div className="bodyAdmin">
            <div className="body1Admin">
                <h1 style={styleTitle} className="text-4xl lg:text-6xl">EJERCICIOS</h1>
            </div>
            <div className="body2Admin">
                <h1 style={styleTitle} className="text-4xl lg:text-6xl">RUTINAS</h1>
            </div>
            ...
            <div className="buttonArea1-admin">
                <NavLink to="addExercise"><button className="button1-admin text-base lg:text-3xl " style={style5}>AÑADIR</button></NavLink>
            </div>
            <div className="buttonArea2-admin">
                <NavLink to="addRoutine"><button className="button2-admin text-base lg:text-3xl "style={style5}>AÑADIR</button></NavLink>
            </div>
